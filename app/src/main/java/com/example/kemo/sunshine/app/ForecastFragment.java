    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... postCode) {
            ...
            try {
                ...
                URL url = fetchURL("json", "metric", NoOfDays, postCode[0]);
        ...
        private URL fetchURL(String format, String units, int noOfDays, String postCode) throws MalformedURLException {
            ...
            //by id instead of postal code
            //us q as query param for postal code and id for city id
            //city ids found at http://openweathermap.org/help/city_list.txt
